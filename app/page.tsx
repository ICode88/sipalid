...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Proses dan manfaat pengelolaan air limbah domestik",
      icon: Info,
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Kami menyediakan berbagai layanan terkait pengelolaan air limbah domestik
              ...
              <Tabs defaultValue="umum" onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="umum" className="space-y-4">
                  <p className="text-lg text-muted-foreground">
                    ...
                    teknis daerah yang bertanggung jawab atas pengelolaan air limbah domestik di
                ...
                <TabsContent value="visi" className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                      <li>Meningkatkan kualitas layanan pengelolaan air limbah domestik</li>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              ...
              terkait pengelolaan air limbah domestik
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-10">
              Hubungi kami untuk informasi lebih lanjut tentang layanan pengelolaan
              air limbah domestik dan cara mendaftarkan diri Anda.
            </p>
