    ...
    questions: [
      {
        ...
        a: "UPTD Pengelolaan Air Limbah Domestik adalah unit pelaksana teknis daerah yang bertanggung jawab atas pengelolaan air limbah domestik di Kabupaten Tanah Bumbu, termasuk pengolahan, pemeliharaan infrastruktur, dan pelayanan kepada masyarakat."
      },
      {
        q: "Dimana lokasi kantor UPTD?",
        a: "Kantor UPTD Pengelolaan Air Limbah Domestik berlokasi di Jl. Example No. 123, Tanah Bumbu, Kalimantan Selatan. Kami melayani masyarakat setiap hari kerja (Senin-Jumat) dari pukul 08.00-16.00 WITA."
      },
      {
      ...
      <section className="relative pt-32 pb-24 bg-gradient-to-b from-cyan-500 to-blue-600 dark:from-cyan-800 dark:to-blue-900 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              Temukan jawaban untuk pertanyaan umum seputar layanan pengelolaan
              air limbah domestik
            </motion.p>
